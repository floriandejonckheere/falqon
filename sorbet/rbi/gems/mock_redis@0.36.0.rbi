...
module MockRedis::ListMethods
  ...
  # source://mock_redis//lib/mock_redis/list_methods.rb#63
  def lindex(key, index); end

  # source://mock_redis//lib/mock_redis/list_methods.rb#67
  def linsert(key, position, pivot, value); end

  # source://mock_redis//lib/mock_redis/list_methods.rb#91
  def llen(key); end

  # source://mock_redis//lib/mock_redis/list_methods.rb#95
...
module MockRedis::StringMethods
  ...
  # source://mock_redis//lib/mock_redis/string_methods.rb#306
  ...
  # source://mock_redis//lib/mock_redis/string_methods.rb#116
  def getrange(key, start, stop); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#121
  def getset(key, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#127
  def incr(key); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#131
  def incrby(key, n); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#147
  def incrbyfloat(key, n); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#175
  def mapped_mget(*keys); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#194
  def mapped_mset(hash); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#209
  def mapped_msetnx(hash); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#163
  def mget(*keys, &blk); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#179
  def mset(*kvpairs); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#198
  def msetnx(*kvpairs); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#343
  def psetex(key, milliseconds, value); end

  # Parameer list required to ensure the ArgumentError is returned correctly
  #
  # source://mock_redis//lib/mock_redis/string_methods.rb#215
  ...
  # source://mock_redis//lib/mock_redis/string_methods.rb#259
  def setbit(key, offset, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#333
  def setex(key, seconds, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#353
  def setnx(key, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#362
  def setrange(key, offset, value); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#372
  def strlen(key); end

  private

  # source://mock_redis//lib/mock_redis/string_methods.rb#383
  def assert_stringy(key, message = T.unsafe(nil)); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#403
  def incr_bitfield(val, incrby, is_signed, type_size, overflow_method); end

  # source://mock_redis//lib/mock_redis/string_methods.rb#390
  def set_bitfield(key, value, is_signed, type_size, offset); end

  # @return [Boolean]
  #
  # source://mock_redis//lib/mock_redis/string_methods.rb#379
  def stringy?(key); end
end
